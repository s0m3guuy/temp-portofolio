            ...
            <nav>
                ...
                <div class="nav-dropdown">
                    ...
                    <div class="nav-dropdown-menu">
                        ...
                        <a href="laporan3.php"><i class="bi bi-file-earmark-bar-graph"></i><span>Pembayaran</span></a>
                    </div>
                </div>
            </nav>
                                        ...
                                        <div class="modal-content">
                                            <form action="anggota_edit.php" method="POST">
                                                ...
                                                <div class="modal-body">
                                                    <div class="mb-3">
                                                        <label class="form-label">Nama *</label>
                                                        <input type="text" class="form-control" name="nama" value="<?= htmlspecialchars($row['nama'], ENT_QUOTES) ?>" required>
                                                    </div>
                                                    <div class="mb-3">
                                                        <label class="form-label">Jenis Usaha</label>
                                                        <input type="text" class="form-control" name="usaha" value="<?= htmlspecialchars($row['usaha'], ENT_QUOTES) ?>">
                                                    </div>
                                                    <div class="mb-3">
                                                        <label class="form-label">No Telephone *</label>
                                                        <input type="text" class="form-control" name="no_telp" value="<?= htmlspecialchars($row['no_telp'], ENT_QUOTES) ?>" required>
                                                    </div>
                                                    <div class="mb-3">
                                                        <label class="form-label">Email</label>
                                                        <input type="email" class="form-control" name="email" value="<?= htmlspecialchars($row['email'], ENT_QUOTES) ?>">
                                                    </div>
                                                    <div class="mb-3">
                                                        <label class="form-label">Alamat</label>
                                                    ...
                                                    <div class="mb-3">
                                                        <label class="form-label">NIK</label>
                                                        <input type="text" class="form-control" name="nik" value="<?= htmlspecialchars($row['NIK'], ENT_QUOTES) ?>">
                                                    </div>
                                                    <div class="mb-3">
                                                        <label class="form-label">TTL</label>
                                                        <input type="text" class="form-control" name="ttl" value="<?= htmlspecialchars($row['ttl'], ENT_QUOTES) ?>">
                                                    </div>
                                                </div>
