...
if(mysqli_stmt_execute($stmt)) {
    header("Location: anggota.php?success=1&message=Pengajuan+pinjaman+berhasil+dibuat");
} else {
    error_log("Database error: " . mysqli_error($koneksi));
    header("Location: anggota.php?error=1&message=" . urlencode("Gagal menyimpan data: " . mysqli_error($koneksi)));
}
